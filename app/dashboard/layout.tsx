          ...
          <div className="flex justify-between items-center h-14 sm:h-16">
            ...
            <div className="flex items-center space-x-1 sm:space-x-2 md:space-x-4">
                ...
                <>
                  ...
                  <Link href="/dashboard/keys">
                    <Button variant="ghost" size="sm" className="h-8 sm:h-9 px-2 sm:px-3">
                      ...
                      <span className="hidden sm:inline text-xs sm:text-sm">Llaves</span>
                    </Button>
                  </Link>
                  <Link href="/dashboard/drivers">
                    <Button variant="ghost" size="sm" className="h-8 sm:h-9 px-2 sm:px-3">
                      ...
                      <span className="hidden sm:inline text-xs sm:text-sm">Choferes</span>
                    </Button>
                  </Link>
                </>
              ) : null}
              <div className="text-right hidden md:block">
                ...
                <p className="text-xs text-gray-600">{isAdmin ? 'Dispatch' : 'Chofer/Staff'}</p>
              </div>
